// To parse this data:
//
//   import { Convert, RandomeUserProps } from "./file";
//
//   const randomeUserProps = Convert.toRandomeUserProps(json);
//
...
export class Convert {
  public static toRandomeUserProps(json: string): RandomeUserProps {
    return cast(JSON.parse(json), r("RandomeUserProps"));
  }

  public static randomeUserPropsToJson(value: RandomeUserProps): string {
    return JSON.stringify(uncast(value, r("RandomeUserProps")), null, 2);
  }
}
